    ...
    <div className="bg-[#2c2f33] p-4 rounded-lg my-6 shadow-lg flex flex-col gap-4">
        ...
        <div className="flex flex-col md:flex-row flex-wrap gap-4 items-center">
             <input
                ...
                className="flex-grow w-full md:w-auto p-2.5 rounded-md border bg-[#1a1a1d] border-[#404040] text-[#e6e6e6] placeholder-gray-500 focus:ring-2 focus:ring-[#4a90e2] focus:border-[#4a90e2] text-sm"
            />
